    ...
    <TitleForm text='Registrar Venta'></TitleForm>
      ...
      <div className="divForm">
        ...
        <div className="selectSimple">
            <h3>Sucursal</h3>
            <select style={{backgroundColor: selectColorBranch}} name="listSelect" onChange={handleIdBranch} className='only_select'>
          ...
          <div className="selectSimple">
            <h3>Usuario</h3>
            <select style={{backgroundColor: selectColorUser}} name="listSelect" onChange={handleIdUser} className='only_select'>
